...
const assembleLayerObjects = async () => {
  ...
  const layerObjects = Promise.all(retrievedJson).then( results => {
    ...
    const google = new CardLayer({
      ...
      icons: [
        {name: 'google', url:'../Studio-Grotto/samples/google.svg'},
      ],
    ...
    const instagram = new CardLayer({
      ...
      icons: [
        {name: 'instagram', url:'../Studio-Grotto/samples/instagram.svg'},
      ],
    ...
    const twitter = new CardLayer({
      name: 'Tweets',
      icons: [
        {name: 'twitter', url:'../Studio-Grotto/samples/twitter.svg'},
      ],
    ...
    return [twitter, hashtags, instagram, google]
  });
